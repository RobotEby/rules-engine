...
/** Limites por entrada. A raiz tem profundidade zero. */
...
/** Verifica dados antes de ler propriedades, copiar ou percorrer o schema. */
...
/** Apenas para dados já validados. Preserva valores e aliases, sem invocar setters. */
export function copyData<T>(value: T, copies = new Map<object, object>()): T {
  ...
  if (Array.isArray(value) && Object.getPrototypeOf(value) === null) Object.setPrototypeOf(result, null);
